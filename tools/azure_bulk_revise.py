...
_BASE_SYSTEM_PROMPT = """You are a revision reviewer for the People's Open Bible — \
...
Output: call submit_verse_revision exactly once. No prose outside the tool call.
